...
import ba.informica.example.mposbampay.audio.AudioMonitor;
import ba.informica.example.mposbampay.audio.AudioMonitorActivity;
import ba.informica.example.mposbampay.audio.HeadsetStateReceiver;
import ba.informica.example.mposbampay.audio.MessageType;
import ba.informica.example.mposbampay.audio.decoder.AudioDecoder;
import ba.informica.example.mposbampay.audio.decoder.SwipeData;

public class MagStripeReader extends AppCompatActivity implements AudioMonitorActivity {
    ...
    @Override
    public void setDongleReady(boolean b) {
